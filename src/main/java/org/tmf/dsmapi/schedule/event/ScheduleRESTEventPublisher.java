...
@Stateless
@Asynchronous
public class ScheduleRESTEventPublisher implements ScheduleRESTEventPublisherLocal {
    ...
    public void publish(Hub hub, ScheduleEvent event) {
        ...
        List<ScheduleEvent> resultList = null;
        resultList = eventFacade.findByCriteria(query, ScheduleEvent.class);
